...
############################
FROM --platform=$BUILDPLATFORM buildpack-deps:stable-scm@sha256:78da6b8b53fe81074fe8effe1e3e9204d2c024e10b47b98bd2955e22721a11a4 AS tdlib-builder
...
# Builder stage
############################
FROM --platform=$BUILDPLATFORM buildpack-deps:stable-scm@sha256:78da6b8b53fe81074fe8effe1e3e9204d2c024e10b47b98bd2955e22721a11a4 AS builder
...
ARG MAUTRIX_META_VERSION=0.2607.0
